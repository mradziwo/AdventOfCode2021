	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="1" Type="Folder">
			<Item Name="Tests" Type="Folder">
				<Item Name="1.1_Test.vi" Type="VI" URL="../1/Tests/1.1_Test.vi"/>
			</Item>
			<Item Name="1.1.vi" Type="VI" URL="../1/1.1.vi"/>
			<Item Name="1.2.vi" Type="VI" URL="../1/1.2.vi"/>
		</Item>
		<Item Name="2" Type="Folder">
			<Item Name="2.1.vi" Type="VI" URL="../2/2.1.vi"/>
			<Item Name="2.2.vi" Type="VI" URL="../2/2.2.vi"/>
		</Item>
		<Item Name="3" Type="Folder">
			<Item Name="tEST" Type="Folder">
				<Item Name="3.1Test.vi" Type="VI" URL="../3/Test/3.1Test.vi"/>
				<Item Name="3.2 resolve.vi" Type="VI" URL="../3/Test/3.2 resolve.vi"/>
				<Item Name="testMostCommon.vi" Type="VI" URL="../3/Test/testMostCommon.vi"/>
			</Item>
			<Item Name="3.1.vi" Type="VI" URL="../3/3.1.vi"/>
			<Item Name="3.2.vi" Type="VI" URL="../3/3.2.vi"/>
			<Item Name="mostCommonValue.vi" Type="VI" URL="../3/SubVis/mostCommonValue.vi"/>
		</Item>
		<Item Name="4" Type="Folder">
			<Item Name="algorithm.vi" Type="VI" URL="../4/algorithm.vi"/>
			<Item Name="algorithm_4.2.vi" Type="VI" URL="../4/algorithm_4.2.vi"/>
			<Item Name="BingoBoard.lvclass" Type="LVClass" URL="../4/BingoBoard/BingoBoard.lvclass"/>
			<Item Name="BoardField.lvclass" Type="LVClass" URL="../4/BoardField/BoardField.lvclass"/>
			<Item Name="parseBoardData.vi" Type="VI" URL="../4/parseBoardData.vi"/>
			<Item Name="parseCallsData.vi" Type="VI" URL="../4/parseCallsData.vi"/>
			<Item Name="parseInputData.vi" Type="VI" URL="../4/parseInputData.vi"/>
			<Item Name="Untitled 4.vi" Type="VI" URL="../4/BingoBoard/Untitled 4.vi"/>
		</Item>
		<Item Name="5" Type="Folder">
			<Item Name="algorithm5.vi" Type="VI" URL="../5/algorithm5.vi"/>
			<Item Name="algorithm52.vi" Type="VI" URL="../5/algorithm52.vi"/>
			<Item Name="pointStringtoXY.vi" Type="VI" URL="../5/pointStringtoXY.vi"/>
			<Item Name="runFile.vi" Type="VI" URL="../5/runFile.vi"/>
			<Item Name="Untitled 7 (SubVI).vi" Type="VI" URL="../5/Untitled 7 (SubVI).vi"/>
		</Item>
		<Item Name="6" Type="Folder">
			<Item Name="run.vi" Type="VI" URL="../5/run.vi"/>
		</Item>
		<Item Name="7" Type="Folder">
			<Item Name="7.1.vi" Type="VI" URL="../7/7.1.vi"/>
			<Item Name="7.2.vi" Type="VI" URL="../7/7.2.vi"/>
		</Item>
		<Item Name="8" Type="Folder">
			<Item Name="8.1.vi" Type="VI" URL="../8/8.1.vi"/>
			<Item Name="8.2.vi" Type="VI" URL="../8/8.2.vi"/>
			<Item Name="B.vi" Type="VI" URL="../8/B.vi"/>
			<Item Name="C.vi" Type="VI" URL="../8/C.vi"/>
			<Item Name="D.vi" Type="VI" URL="../8/D.vi"/>
			<Item Name="E.vi" Type="VI" URL="../8/E.vi"/>
			<Item Name="F.vi" Type="VI" URL="../8/F.vi"/>
			<Item Name="G.vi" Type="VI" URL="../8/G.vi"/>
			<Item Name="getA.vi" Type="VI" URL="../8/getA.vi"/>
		</Item>
		<Item Name="9" Type="Folder">
			<Item Name="9.1.vi" Type="VI" URL="../9/9.1.vi"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Lib_ThsCache.lvlib" Type="Library" URL="/&lt;vilib&gt;/SGRE/Lib_ThsCache/Lib_ThsCache.lvlib"/>
				...
				<Item Name="THSDataAPI.lvlib" Type="Library" URL="/&lt;vilib&gt;/SWP/THSDataAPI/THSDataAPI.lvlib"/>
				<Item Name="THSModuleSupport.lvlib" Type="Library" URL="/&lt;vilib&gt;/SWP/THSModuleSupport/THSModuleSupport.lvlib"/>
			...
			<Item Name="DI_VibrationGuard.lvclass" Type="LVClass" URL="../../../../../../git/THS_Modules/Source/Modules/Simulation/VibrationGuard/DI_VibrationGuard/DI_VibrationGuard.lvclass"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="SSD.lvclass" Type="LVClass" URL="../../../../../../git/THS_Modules/Source/Modules/Simulation/VibrationGuard/SSD/SSD.lvclass"/>
			<Item Name="SSVG.lvclass" Type="LVClass" URL="../../../../../../git/THS_Modules/Source/Modules/Simulation/VibrationGuard/SSVG/SSVG.lvclass"/>
			<Item Name="VibrationGuard.lvclass" Type="LVClass" URL="../../../../../../git/THS_Modules/Source/Modules/Simulation/VibrationGuard/VibrationGuard/VibrationGuard.lvclass"/>
		</Item>
